...
const configuration = {
  ...
  slack_user_token: process.env.STARBOT_SLACK_USER_TOKEN,
  ...
  reaction_emoji: process.env.STARBOT_REACTION_EMOJI || 'white_check_mark',
  favorites_reaction_emoji: process.env.STARBOT_FAVORITES_REACTION_EMOJI || 'star'
};
